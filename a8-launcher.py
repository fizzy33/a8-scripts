...
class a8_UserConfig:
    ...
    def loadRepoConfig():
        ...
        _g.h["repo_url"] = "defeahttps://locus.accur8.net/repos/all"
        _g.h["maven_url"] = "asdfasdfhttps://repo.maven.apache.org/maven2/"
        ...
        m1 = a8_HaxeOps.mapMerge(defaults,userProps)
        # src/a8/UserConfig.hx:37
        m2 = a8_HaxeOps.mapMerge(m1,etcProps)
        # src/a8/UserConfig.hx:38
        haxe_Log.trace("boom",_hx_AnonObject({'fileName': "src/a8/UserConfig.hx", 'lineNumber': 38, 'className': "a8.UserConfig", 'methodName': "loadRepoConfig"}))
        # src/a8/UserConfig.hx:39
        haxe_Log.trace(("null" if ((m2 is None)) else m2.toString()),_hx_AnonObject({'fileName': "src/a8/UserConfig.hx", 'lineNumber': 39, 'className': "a8.UserConfig", 'methodName': "loadRepoConfig"}))
...
class haxe_ds_StringMap:
    ...
    def toString(self):
        # /Users/glen/bin/haxe-4.2.5/std/python/_std/haxe/ds/StringMap.hx:74
        s_b = python_lib_io_StringIO()
        # /Users/glen/bin/haxe-4.2.5/std/python/_std/haxe/ds/StringMap.hx:76
        s_b.write("{")
        # /Users/glen/bin/haxe-4.2.5/std/python/_std/haxe/ds/StringMap.hx:77
        it = self.keys()
        # /Users/glen/bin/haxe-4.2.5/std/python/_std/haxe/ds/StringMap.hx:78
        # /Users/glen/bin/haxe-4.2.5/std/python/_std/haxe/ds/StringMap.hx:78
        i = it
        while i.hasNext():
            i1 = i.next()
            # /Users/glen/bin/haxe-4.2.5/std/python/_std/haxe/ds/StringMap.hx:79
            s_b.write(Std.string(i1))
            # /Users/glen/bin/haxe-4.2.5/std/python/_std/haxe/ds/StringMap.hx:80
            s_b.write(" => ")
            # /Users/glen/bin/haxe-4.2.5/std/python/_std/haxe/ds/StringMap.hx:81
            s_b.write(Std.string(Std.string(self.h.get(i1,None))))
            # /Users/glen/bin/haxe-4.2.5/std/python/_std/haxe/ds/StringMap.hx:82
            if it.hasNext():
                s_b.write(", ")
        # /Users/glen/bin/haxe-4.2.5/std/python/_std/haxe/ds/StringMap.hx:85
        s_b.write("}")
        # /Users/glen/bin/haxe-4.2.5/std/python/_std/haxe/ds/StringMap.hx:86
        return s_b.getvalue()
